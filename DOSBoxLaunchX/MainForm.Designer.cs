namespace DOSBoxLaunchX
{
    partial class MainForm
    {
		...
		private void InitializeComponent() {
			...
			comboKbStopTurbo = new ComboBox();
			cbKbStopTurboSet = new CheckBox();
			lblKbStopTurbo = new Label();
			...
			tabGeneral.Controls.Add(pnlGeneralSettingsMain);
			...
			tabGeneral.Controls.Add(grpSeparator);
			...
			pnlGeneralSettingsMain.Controls.Add(comboLimitBaseDirFreeSpace);
			pnlGeneralSettingsMain.Controls.Add(cbLimitBaseDirFreeSpaceSet);
			pnlGeneralSettingsMain.Controls.Add(lblLimitBaseDirFreeSpace);
			pnlGeneralSettingsMain.Controls.Add(cbExecutableSet);
			pnlGeneralSettingsMain.Controls.Add(txtExecutable);
			pnlGeneralSettingsMain.Controls.Add(lblExecutable);
			pnlGeneralSettingsMain.Controls.Add(cbBaseDirSet);
			pnlGeneralSettingsMain.Controls.Add(lblGeneralSet);
			pnlGeneralSettingsMain.Controls.Add(txtBaseDir);
			pnlGeneralSettingsMain.Controls.Add(lblBaseDir);
			pnlGeneralSettingsMain.Controls.Add(lblDescription);
			pnlGeneralSettingsMain.Controls.Add(txtName);
			...
			// 
			// comboShowDescriptionPreLaunch
			// 
			comboShowDescriptionPreLaunch.DropDownStyle = ComboBoxStyle.DropDownList;
			comboShowDescriptionPreLaunch.FormattingEnabled = true;
			comboShowDescriptionPreLaunch.Items.AddRange(new object[] { "No", "Yes" });
			comboShowDescriptionPreLaunch.Location = new Point(258, 145);
			comboShowDescriptionPreLaunch.Name = "comboShowDescriptionPreLaunch";
			comboShowDescriptionPreLaunch.Size = new Size(110, 23);
			comboShowDescriptionPreLaunch.TabIndex = 31;
			comboShowDescriptionPreLaunch.Tag = "nl=false";
			// 
			// lblShowDescriptionPreLaunch
			// 
			lblShowDescriptionPreLaunch.AutoSize = true;
			lblShowDescriptionPreLaunch.Location = new Point(36, 148);
			lblShowDescriptionPreLaunch.Name = "lblShowDescriptionPreLaunch";
			lblShowDescriptionPreLaunch.Size = new Size(190, 15);
			lblShowDescriptionPreLaunch.TabIndex = 100;
			lblShowDescriptionPreLaunch.Text = "^ Show description on pre-launch:";
			// 
			// btnUseDosboxBaseDirBrowse
			// 
			btnUseDosboxBaseDirBrowse.Location = new Point(522, 290);
			btnUseDosboxBaseDirBrowse.Name = "btnUseDosboxBaseDirBrowse";
			btnUseDosboxBaseDirBrowse.Size = new Size(75, 23);
			btnUseDosboxBaseDirBrowse.TabIndex = 82;
			...
			lblUseDosboxBaseDir.Location = new Point(36, 293);
			...
			lblExitAfterTerminate.Location = new Point(36, 264);
			...
			lblNameDescriptionNote.TabIndex = 81;
			...
			cbBaseDirSet.Location = new Point(11, 178);
			cbBaseDirSet.Name = "cbBaseDirSet";
			cbBaseDirSet.Size = new Size(15, 14);
			cbBaseDirSet.TabIndex = 40;
			cbBaseDirSet.Tag = "";
			...
			lblBaseDir.Location = new Point(36, 177);
			lblBaseDir.Name = "lblBaseDir";
			lblBaseDir.Size = new Size(84, 15);
			lblBaseDir.TabIndex = 76;
			...
			lblDescription.Cursor = Cursors.Help;
			lblDescription.Font = new Font("Segoe UI", 9F, FontStyle.Underline, GraphicsUnit.Point, 0);
			...
			// 
			btnLogOutputFileBrowse.Location = new Point(522, 391);
			...
			cbLogOutputFileSet.Location = new Point(11, 395);
			...
			// txtLogOutputFile
			// 
			txtLogOutputFile.Location = new Point(168, 391);
			...
			lblLogOutputFile.Location = new Point(36, 394);
			...
			cbOpenLoggingConsoleSet.Location = new Point(11, 366);
			...
			// grpSeparator
			// 
			grpSeparator.Location = new Point(11, 327);
			...
			comboOpenLoggingConsole.Location = new Point(291, 362);
			...
			lblOpenLoggingConsole.Location = new Point(36, 365);
			...
			tabPeripherals.Controls.Add(grpKeyboard);
			...
			// grpKeyboard
			// 
			grpKeyboard.Controls.Add(comboKbStopTurbo);
			grpKeyboard.Controls.Add(cbKbStopTurboSet);
			grpKeyboard.Controls.Add(lblKbStopTurbo);
			grpKeyboard.Controls.Add(comboKbLayout);
			grpKeyboard.Controls.Add(cbKbLayoutSet);
			grpKeyboard.Controls.Add(lblKbLayout);
			grpKeyboard.Location = new Point(4, 25);
			grpKeyboard.Name = "grpKeyboard";
			grpKeyboard.Size = new Size(603, 77);
			grpKeyboard.TabIndex = 10;
			grpKeyboard.TabStop = false;
			grpKeyboard.Text = "Keyboard";
			// 
			// comboKbStopTurbo
			// 
			comboKbStopTurbo.FormattingEnabled = true;
			comboKbStopTurbo.Items.AddRange(new object[] { "true", "false" });
			comboKbStopTurbo.Location = new Point(184, 45);
			comboKbStopTurbo.Name = "comboKbStopTurbo";
			comboKbStopTurbo.Size = new Size(409, 23);
			comboKbStopTurbo.TabIndex = 21;
			comboKbStopTurbo.Tag = "cb=cbKbStopTurboSet|assoc=lblKbStopTurbo|setting=cpu.stop turbo on key";
			// 
			// cbKbStopTurboSet
			// 
			cbKbStopTurboSet.AutoSize = true;
			cbKbStopTurboSet.Location = new Point(7, 49);
			cbKbStopTurboSet.Name = "cbKbStopTurboSet";
			cbKbStopTurboSet.Size = new Size(15, 14);
			cbKbStopTurboSet.TabIndex = 20;
			cbKbStopTurboSet.Tag = "";
			cbKbStopTurboSet.UseVisualStyleBackColor = true;
			// 
			// lblKbStopTurbo
			// 
			lblKbStopTurbo.AutoSize = true;
			lblKbStopTurbo.Cursor = Cursors.Help;
			lblKbStopTurbo.Font = new Font("Segoe UI", 9F, FontStyle.Underline, GraphicsUnit.Point, 0);
			lblKbStopTurbo.Location = new Point(32, 48);
			lblKbStopTurbo.Name = "lblKbStopTurbo";
			lblKbStopTurbo.Size = new Size(131, 15);
			lblKbStopTurbo.TabIndex = 74;
			lblKbStopTurbo.Text = "Stop turbo on keypress:";
			lblKbStopTurbo.Click += lblKbStopTurbo_Click;
			// 
			// comboKbLayout
			// 
			...
			comboKbLayout.Location = new Point(184, 16);
			...
			cbKbLayoutSet.Location = new Point(7, 20);
			...
			lblKbLayout.Location = new Point(32, 19);
			lblKbLayout.Name = "lblKbLayout";
			lblKbLayout.Size = new Size(96, 15);
			lblKbLayout.TabIndex = 71;
			...
			btnPrintDocDirBrowse.TabIndex = 112;
			...
			cbPrinterDeviceSet.TabIndex = 100;
			...
			comboEnablePrinter.TabIndex = 81;
			...
			cbEnablePrinterSet.TabIndex = 80;
			...
			grpMouse.Location = new Point(4, 108);
			grpMouse.Name = "grpMouse";
			grpMouse.Size = new Size(603, 164);
			grpMouse.TabIndex = 30;
			...
			comboMouseAutolockFeedback.TabIndex = 71;
			...
			cbMouseAutolockFeedbackSet.TabIndex = 70;
			...
			comboMouseAutolock.TabIndex = 61;
			...
			cbMouseAutolockSet.TabIndex = 60;
			...
			comboMouseSensitivity.TabIndex = 51;
			...
			cbMouseSensitivitySet.TabIndex = 50;
			...
			comboMouseEmulation.TabIndex = 31;
			...
			cbMouseEmulationSet.TabIndex = 30;
			...
			comboMouseMiddleUnlock.TabIndex = 41;
			...
			cbMouseMiddleUnlockSet.TabIndex = 40;
			...
			pnlGeneralSettingsMain.ResumeLayout(false);
			pnlGeneralSettingsMain.PerformLayout();
		...
		private Panel pnlGeneralSettingsMain;
		...
		private CheckBox cbKbStopTurboSet;
		...
		private ComboBox comboKbStopTurbo;
		private Label lblKbStopTurbo;
	}
}
